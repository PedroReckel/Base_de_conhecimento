<template>
    <div class="auth-content">
        <div class="auth-modal">
            <img src="../../assets/logoUpsilion.jpg" width="200" alt="Logo">
            <hr>
            ...
            </a> <!-- Quando eu clicar no link a partir do @click eu quero previnir o comportamento padrão sem nenhuma ação --> 
        </div>
    </div>
</template>
...
export default {
    ...
    data: function() {
        return {
            showSignup: false, // Auternar entre login e singup
            user: {}
        }
    },
    methods: {
